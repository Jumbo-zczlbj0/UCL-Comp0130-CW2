...
end % LandmarksList = [3           4         106         171         346         563        1104]
NumberOfEdgeConnectLandmark = 0;
for k = 1:length(LandmarksList)
    NumberOfEdgeConnectLandmark = NumberOfEdgeConnectLandmark + length(edges(allVertices{LandmarksList(k)}));
end
Avg1 = NumberOfEdgeConnectLandmark / length(LandmarksList) % 484.14
Avg2 = NumberOfEdgeConnectLandmark / (length(allVertices) - length(LandmarksList)) % 0.6427
